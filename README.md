...
- 开发者: Claude Code助手 + 用户协作开发

## 更新日志

### v1.0.1 (2025-11-08)
- ✅ 插件名称系统性重命名为 "BuildingCodeChecker"
- ✅ 优化面板规范信息显示格式，减少换行
- ✅ 增加规范信息显示区域高度（60px → 85px）
- ✅ 面板中文化：按钮改为"上传PDF"和"开始检测"

### v1.0.0 (2025-11-08)
- ✅ 完成Python RAG规范提取工具
- ✅ 完成ArchiCAD C++插件开发
- ✅ 实现端到端的PDF规范上传→提取→检测流程
- ✅ 支持踏步高度和宽度的合规性检测
- ✅ 修复UTF-8编码解析问题
- ✅ 修复小文件EOF读取问题
- ✅ 优化regulation_name提取准确性
- ✅ 面板打开时清空旧结果，提供干净的用户体验
